...
namespace SimpleServiceClient.Registration
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Registers only the service manager to the container with a profile.
        /// </summary>
        ...
        public static void AddServiceClient<TClient, TImplementation>(this IServiceCollection services)
            where TClient : class
            where TImplementation : BaseServiceClient, TClient
        {
            services.AddTransient<IServiceManager<DefaultClientProfile>, ServiceManager<DefaultClientProfile>>();
        ...
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <param name="services">An instance of the <see cref="IServiceCollection"/> interface.</param>
        public static void AddServiceClient<TImplementation>(this IServiceCollection services)
            where TImplementation : BaseServiceClient
        {
            services.AddTransient<IServiceManager<DefaultClientProfile>, ServiceManager<DefaultClientProfile>>();
        ...
        /// <summary>
        /// Registers a service to the container with a resilience pipeline.
        /// </summary>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <param name="services">An instance of the <see cref="IServiceCollection"/> interface.</param>
        /// <param name="pipeline">An <see cref="ResiliencePipeline{T}"/> instance for policy registration.</param>
        public static void AddServiceClient<TImplementation>(this IServiceCollection services, ResiliencePipeline<HttpResponseMessage> pipeline)
            where TImplementation : BaseServiceClient
        {
            services.AddTransient<IServiceManager<DefaultClientProfile>, ServiceManager<DefaultClientProfile>>();
        ...
        /// <summary>
        /// Registers a service client to the container with a profile and custom client implementation.
        /// </summary>
        /// <typeparam name="TClient">The type of the client interface.</typeparam>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        ...
        /// <summary>
        /// Registers a service to the container with a profile and custom client implementation.
        /// </summary>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <typeparam name="TProfile">The type of the service profile.</typeparam>
        /// <param name="services">An instance of the <see cref="IServiceCollection"/> interface.</param>
        /// <param name="clientAction">An <see cref="Action"/> to configure the <see cref="HttpClient"/>.</param>
        public static void AddServiceClient<TImplementation, TProfile>(this IServiceCollection services, Action<HttpClient> clientAction)
            where TImplementation : BaseServiceClient<TProfile>
            where TProfile : ServiceClientProfile
        {
            services.AddTransient<IServiceManager<TProfile>, ServiceManager<TProfile>>();
        ...
        /// <summary>
        /// Registers a service client to the container with a profile, custom client implementation, and resilience pipeline.
        /// </summary>
        /// <typeparam name="TClient">The type of the client interface.</typeparam>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <typeparam name="TProfile">The type of the service profile.</typeparam>
        ...
        /// <summary>
        /// Registers a service to the container with a profile, custom client implementation, and resilience pipeline.
        /// </summary>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <typeparam name="TProfile">The type of the service profile.</typeparam>
        /// <param name="services">An instance of the <see cref="IServiceCollection"/> interface.</param>
        /// <param name="clientAction">An <see cref="Action"/> to configure the <see cref="HttpClient"/>.</param>
        /// <param name="pipeline">An <see cref="ResiliencePipeline{T}"/> instance for policy registration.</param>
        public static void AddServiceClient<TImplementation, TProfile>(this IServiceCollection services, Action<HttpClient> clientAction, ResiliencePipeline<HttpResponseMessage> pipeline)
            where TImplementation : BaseServiceClient<TProfile>
            where TProfile : ServiceClientProfile
        {
            services.AddTransient<IServiceManager<TProfile>, ServiceManager<TProfile>>();
        ...
        public static void AddTranslatedServiceClient<TClient, TImplementation>(this IServiceCollection services, params Assembly[] assemblies)
            where TClient : class
            where TImplementation : BaseTranslatedServiceClient, TClient
        {
            services.AddTransient<IServiceManager<DefaultClientProfile>, ServiceManager<DefaultClientProfile>>();
        ...
        /// <summary>
        /// Registers a translated service to the container.
        /// </summary>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <param name="services">An instance of the <see cref="IServiceCollection"/> interface.</param>
        /// <param name="assemblies">An <see cref="IEnumerable{T}"/> of <see cref="Assembly"/> to register factories for.</param>
        public static void AddTranslatedServiceClient<TImplementation>(this IServiceCollection services, params Assembly[] assemblies)
            where TImplementation : BaseTranslatedServiceClient
        {
            services.AddTransient<IServiceManager<DefaultClientProfile>, ServiceManager<DefaultClientProfile>>();
        ...
        /// <summary>
        /// Registers a translated service client to the container with a resilience pipeline.
        /// </summary>
        /// <typeparam name="TClient">The type of the client interface.</typeparam>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <param name="services">An instance of the <see cref="IServiceCollection"/> interface.</param>
        ...
        /// <summary>
        /// Registers a translated service to the container with a resilience pipeline.
        /// </summary>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <param name="services">An instance of the <see cref="IServiceCollection"/> interface.</param>
        /// <param name="pipeline">An <see cref="ResiliencePipeline{T}"/> instance for policy registration.</param>
        /// <param name="assemblies">An <see cref="IEnumerable{T}"/> of <see cref="Assembly"/> to register factories for.</param>
        public static void AddTranslatedServiceClient<TImplementation>(this IServiceCollection services, ResiliencePipeline<HttpResponseMessage> pipeline, params Assembly[] assemblies)
            where TImplementation : BaseTranslatedServiceClient
        {
            services.AddTransient<IServiceManager<DefaultClientProfile>, ServiceManager<DefaultClientProfile>>();
        ...
        /// <summary>
        /// Registers a translated service client to the container with a custom client implementation.
        /// </summary>
        /// <typeparam name="TClient">The type of the client interface.</typeparam>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <typeparam name="TProfile">The type of the service profile.</typeparam>
        ...
        /// <summary>
        /// Registers a translated service to the container with a custom client implementation.
        /// </summary>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <typeparam name="TProfile">The type of the service profile.</typeparam>
        /// <param name="services">An instance of the <see cref="IServiceCollection"/> interface.</param>
        /// <param name="clientAction">An <see cref="Action"/> to configure the <see cref="HttpClient"/>.</param>
        /// <param name="assemblies">An <see cref="IEnumerable{T}"/> of <see cref="Assembly"/> to register factories for.</param>
        public static void AddTranslatedServiceClient<TImplementation, TProfile>(this IServiceCollection services, Action<HttpClient> clientAction, params Assembly[] assemblies)
            where TImplementation : BaseTranslatedServiceClient<TProfile>
            where TProfile : ServiceClientProfile
        {
            services.AddTransient<IServiceManager<TProfile>, ServiceManager<TProfile>>();
        ...
        /// <summary>
        /// Registers a translated service client to the container with a custom client implementation and resilience pipeline.
        /// </summary>
        /// <typeparam name="TClient">The type of the client interface.</typeparam>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <typeparam name="TProfile">The type of the service profile.</typeparam>
        ...
        /// <summary>
        /// Registers a translated service to the container with a custom client implementation and resilience pipeline.
        /// </summary>
        /// <typeparam name="TImplementation">The type of the client implementation.</typeparam>
        /// <typeparam name="TProfile">The type of the service profile.</typeparam>
        /// <param name="services">An instance of the <see cref="IServiceCollection"/> interface.</param>
        ...
        /// <param name="pipeline">An <see cref="ResiliencePipeline{T}"/> instance for policy registration.</param>
        /// <param name="assemblies">An <see cref="IEnumerable{T}"/> of <see cref="Assembly"/> to register factories for.</param>
        public static void AddTranslatedServiceClient<TImplementation, TProfile>(this IServiceCollection services, Action<HttpClient> clientAction, ResiliencePipeline<HttpResponseMessage> pipeline, params Assembly[] assemblies)
            where TImplementation : BaseTranslatedServiceClient<TProfile>
            where TProfile : ServiceClientProfile
        {
            services.AddTransient<IServiceManager<TProfile>, ServiceManager<TProfile>>();
